...
<div class="timeline-buttons" class:active={curr_index === 0} bind:offsetHeight={button_carousel_height}>
    ...
    <a class="cv-button" href="https://raw.githubusercontent.com/08Aristodemus24/project-alexander/master/client-side/src/boards/Larry_Miguel_R_Cueva_CV.pdf" download="Larry_Miguel_R_Cueva_CV.pdf">
